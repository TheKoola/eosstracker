...
(function($) {
	function FlightIndicator( placeholder, type, options ) {
		...
		placeholder.each(function(){
			switch(type){
				case 'heading':
					$(this).html('<div class="instrument heading"><img src="' + settings.img_directory + 'fi_box.svg" class="background box" alt="" /><div class="heading box"><img src="' + settings.img_directory + 'heading_yaw.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + settings.img_directory + 'heading_mechanics_text.svg" class="box" alt="" /><img src="' + settings.img_directory + 'heading_mechanics.svg" class="box" alt="" /><img src="' + settings.img_directory + 'fi_circle.svg" class="box" alt="" /></div></div>');
					_setHeading(settings.heading);
				break;
				case 'relativeHeading':
					$(this).html('<div class="instrument relative_heading"><img src="' + settings.img_directory + 'fi_box.svg" class="background box" alt="" /><div class="relative_heading box"><img src="' + settings.img_directory + 'heading_yaw.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + settings.img_directory + 'relativeheading_mechanics.svg" class="box" alt="" /><img src="' + settings.img_directory + 'relativeheading_mechanics_text.svg" class="box" alt="" /></div><div class="needleRelative box"><img src="' + settings.img_directory + 'fi_needle_relative.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + settings.img_directory + 'fi_circle.svg" class="box" alt="" /></div></div>');
					_setRelativeHeading(settings.heading, settings.relativeHeading);
				break;
				case 'elevationAngle':
					$(this).html('<div class="instrument elevation_angle"><img src="' + settings.img_directory + 'fi_box.svg" class="background box" alt="" /><div class="elevation_angle box"><img src="' + settings.img_directory + 'elevation_yaw.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + settings.img_directory + 'elevationangle_mechanics_text.svg" class="box" alt="" /></div><div class="needleElevation box"><img src="' + settings.img_directory + 'fi_needle.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + settings.img_directory + 'fi_circle.svg" class="box" alt="" /></div></div>');
					_setElevationAngle(settings.elevationAngle);
				break;
				case 'variometer':
				...
				break
				case 'altimeter':
					$(this).html('<div class="instrument altimeter"><img src="' + settings.img_directory + 'fi_box.svg" class="background box" alt="" /><div class="pressure box"><img src="' + settings.img_directory + 'altitude_pressure.svg" class="box" alt="" /></div><img src="' + settings.img_directory + 'altitude_ticks.svg" class="box" alt="" /><div class="needleSmall box"><img src="' + settings.img_directory + 'fi_needle_small.svg" class="box" alt="" /></div><div class="needleExtraSmall box"><img src="' + settings.img_directory + 'fi_needle_xsmall.svg" class="box" alt="" /></div><div class="needle box"><img src="' + settings.img_directory + 'fi_needle.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + settings.img_directory + 'fi_circle.svg" class="box" alt="" /></div></div>');
		...
		function _setRelativeHeading(heading, relHeading){
                        var i;
			var needle;

                        i = relHeading - heading;
                        if (i < 0)
                            needle = 360 + i;
                        else
                            needle = i; 
			placeholder.each(function(){
				$(this).find('div.instrument.relative_heading div.relative_heading').css('transform', 'rotate(' + -heading + 'deg)');
                                // now point the needle towards the relHeading direction
				$(this).find('div.instrument.relative_heading div.needleRelative').css('transform', 'rotate(' + needle + 'deg)');
			});	
		}
		...
		function _setElevationAngle(angle){
			var needle;
                        ...
                        if (angle > 90)
                            ...
                            needle = angle;
			placeholder.each(function(){
				$(this).find('div.instrument.elevation_angle div.needleElevation').css('transform', 'rotate(' + needle + 'deg)');
			});	
		}

		function _setAltitude(altitude){
			var needle = 90 + altitude % 1000 * 360 / 1000;
			var needleSmall = altitude % 10000 * 360 / 10000;
			var needleExtraSmall = 90 + altitude % 100000 * 360 / 100000;
			placeholder.each(function(){
				...
				$(this).find('div.instrument.altimeter div.needleExtraSmall').css('transform', 'rotate(' + needleExtraSmall + 'deg)');
			});	
		}
		...
		this.setRelativeHeading = function(heading, relativeheading){_setRelativeHeading(heading, relativeheading);}
		this.setElevationAngle = function(angle){_setElevationAngle(angle);}
