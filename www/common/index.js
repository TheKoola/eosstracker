  ...
  for (i = 0; i < keys.length; i++) {
    ...
    for (i = 0; i < antennas.length; i++) {
        ...
        antenna_html = antenna_html + "<div class=\"div-table\" style=\"float: left;\">"
            ...
            + "</div>"
            + "<div class=\"table-row\">"
            + "    <div class=\"table-cell\" style=\"border-bottom: none;\">Frequencies</div>"
            + "    <div class=\"table-cell\" style=\"border-bottom: none; border-left: none; text-align: right;\">" + freqhtml + "</div>"
            + "</div>"
            + "<div class=\"table-row\">"
            + "    <div class=\"table-cell\" style=\"border-bottom: none;\">GnuRadio Status</div>"
            + "    <div class=\"table-cell\" style=\"border-bottom: none; border-left: none; text-align: right;\"><mark class=\"okay\">[Okay]</mark></div>"
            + "</div>"
            + "<div class=\"table-row\">"
            + "    <div class=\"table-cell\" style=\"border-bottom: none;\">SDR Information</div>"
            + "    <div class=\"table-cell\" style=\"border-bottom: none; border-left: none; text-align: right;\">RTL-SDR #: " + rtl_id + "<br>Product: " + antennas[i].rtl_product + "<br>Manufacturer: " + antennas[i].rtl_manufacturer  + "<br>Serial No: " + antennas[i].rtl_serialnumber + "</div>"
            + "</div>"
            + "<div class=\"table-row\">"
            + "    <div class=\"table-cell\" style=\"border-bottom: none;\">Igating Status</div>"
            + "    <div class=\"table-cell\" style=\"border-bottom: none; border-left: none; text-align: right;\">" + (statusJson.igating == "true" ? "<mark class=\"okay\">[igating]</mark>" : "<span style=\"font-variant: small-caps;\">[NO]</span>") + "</div>"
            + "</div>"
            + "<div class=\"table-row\">"
