    ...
    <div class="gallery-area">
            ...
            <p class="normal-black">
                ...
                <tr><td class="packetlist"><input type="image" form="launchsite_form" src="/images/graphics/addicon.png" style="width: 22px; height: 22px;" onclick="addLaunchSite(); return false;"></td>
                    <td class="packetlist"><input type="text"  form="launchsite_form" size="25" maxlength="64" name="launchsite_name" id="launchsite_name" autocomplete="off" autocapitalize="off" spellcheck="false" autocorrect="off" required="required" placeholder="launch site">
