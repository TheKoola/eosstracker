    ...
    ***********/
    ...
    function getrecentdata() {
	  ...
	  for (i = 0; i < keys.length; i++) {
              document.getElementById(statusJson.processes[i].process + "-status").innerHTML = "<font style=\"font-variant: small-caps;\"><mark style=\"background-color:  " + (statusJson.processes[i].status > 0 ? "lightgreen;\">[Okay]" : "white;\">[Kiosk Mode]") + "</font></mark>";
