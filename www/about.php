...
<div class="main">
    <div class="gallery-area" style="float:  left;">
            ...
            <p class="normal-black"><a class="normal-link" target="_blank" href="https://www.eoss.org"><img src="/images/graphics/eosslogo.png" style="width: 250px; float: right; margin: 30px; margin-top: 0px;"></a></p> 
	    ...
	    leveraging open source software and the amateur radio <a class="normal-link-black" target="_blank" href="http://www.aprs.org">Automatic Packet Reporting System</a> to provide near real time status and location updates.
            ...
            <p class="normal-black" style="text-align: center; margin-top: 40px; margin-bottom: 0px;">
            Copyright (C) 2019, Jeff Deaton (N6BA)
            </p>
</div>
