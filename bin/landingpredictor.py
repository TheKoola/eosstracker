...
class LandingPredictor(PredictorBase):
    ...
    def processPredictions(self):
        ...
        flightids = queries.getFlights(self.landingconn)
        ...
        try:
            ...
            for rec in flightids:
                ...
                #    elapsed_mins
                latestpackets =  np.array(queries.getLatestPackets(self.landingconn, callsign, self.timezone, 20))
                ...
                if is_descending:
                    ...
                    gpsposition = queries.getGPSPosition(self.landingconn)
                    ...
                    if gps_estimate == False:
                        ...
                        estimate = queries.getLandingElevation(self.landingconn, callsign, 30)
                        if estimate > 0:
                    ...
                    winds, validity = queries.getSurfaceWinds(self.landingconn, fid)
                    ...
                    if len(rows) > 0:
                        ...
                        if latest_altitude > alt_sanity_threshold:
                            ...
                            if cutdown_predictiondata_slice.shape[0] > 0:
                                ...
                                # Get our latest position
                                gpspos = queries.getGPSPosition(self.landingconn)
